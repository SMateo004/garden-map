    ...
    return LegalScreen(
      ...
      sections: const [
        ...
        _LegalSection(
          ...
          '• Datos de verificación: para cuidadores, fotografía del carnet de identidad (CI) para validar la identidad, un contacto de emergencia (nombre y teléfono) requerido para ofrecer Hospedaje o Guardería, y opcionalmente un documento de antecedentes penales (FELCC/REJAP) para obtener el distintivo "Antecedentes verificados".\n'
          '• PIN de seguridad: un PIN de 4 dígitos (almacenado como hash, nunca en texto plano) que protege el acceso a tu billetera y, si eres cuidador, a la gestión de tus reservas activas.\n'
        ...
        _LegalSection(
          ...
          '• Pagos: se procesan mediante QR bancario (Sistema de Pagos Instantáneos - SIP) cuando esté disponible, o mediante transferencia bancaria con verificación manual de Garden mientras esa integración esté en curso. Garden puede habilitar de forma opcional el pago con tarjeta de crédito/débito como método adicional (actualmente desactivado por defecto); si se activa, el proveedor de procesamiento de pagos correspondiente será igualmente detallado en esta política.\n'
